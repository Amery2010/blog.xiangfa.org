/* PrismJS 1.21.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+c+cpp+dart+docker+git+graphql+http+hsts+ignore+json+json5+latex+makefile+markdown+mongodb+nginx+python+jsx+tsx+rust+scss+typescript+typoscript+vim+wasm+yaml&plugins=line-numbers+show-language+toolbar+copy-to-clipboard */
